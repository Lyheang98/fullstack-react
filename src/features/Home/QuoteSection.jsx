        ...
        <section className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-black text-base md:text-lg leading-relaxed mt-4"> 
              get your favorite perfume at your door step. We deliver worldwide 
              with free shipping on orders over $50. Shop now and experience 
              the convenience of online shopping with fast and reliable delivery. 
            </p>
