      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="flex items-center">
              ...
              >
                <path
                  ...
                  strokeWidth="2"
                  d="M19 21V5m-14 0v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"
                />
              </svg>
            ...
            <div className="flex space-x-4">
              ...
              >
                ...
                >
                  ...
                  8.348 0 002.046-2.127 8.19 8.19 0 
              ...
              >
                ...
                >
                  <path
                    ...
                    1.407.06 4.123v.08c0 
                    2.643-.012 2.987-.06 4.043-.049 
                    1.064-.218 1.791-.465 
                    2.427a4.902 4.902 0 
                    01-1.153 1.772 4.902 4.902 
                    ...
                    4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427A4.902 4.902 0 015.45 
                    2.525c.636-.247 1.363-.416 2.427-.465C8.901 2.013 9.256 
                    2 11.685 2h.63zM12 6.865a5.135 5.135 0 
                    110 10.27 5.135 5.135 0 
                    010-10.27z"
                  />
                </svg>
              </Link>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><Link to="/services/web" className="text-gray-400 hover:text-white transition">Web Development</Link></li>
              <li><Link to="/services/mobile" className="text-gray-400 hover:text-white transition">Mobile Apps</Link></li>
              <li><Link to="/services/uiux" className="text-gray-400 hover:text-white transition">UI/UX Design</Link></li>
              <li><Link to="/services/marketing" className="text-gray-400 hover:text-white transition">Digital Marketing</Link></li>
              <li><Link to="/services/cloud" className="text-gray-400 hover:text-white transition">Cloud Solutions</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <address className="not-italic text-gray-400">
              ...
              <p className="mt-2">
                Email:{" "}
                <Link to="mailto:kenzzypich9898@gmail.com" className="hover:text-white transition">
                  Personal.com
                </Link>
              </p>
              <p>
                Phone:{" "}
                <Link to="tel:+11234567890" className="hover:text-white transition">
                  +1 (123) 456-7890
                </Link>
              </p>
            </address>
        ...
        <div className="border-t border-white pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            ...
            <Link to="/blog" className="text-gray-500 hover:text-white text-sm transition">Terms of Service</Link>
            <Link to="/shop" className="text-gray-500 hover:text-white text-sm transition">Cookies</Link>
          </div>
        </div>
      </div>
    </footer>
